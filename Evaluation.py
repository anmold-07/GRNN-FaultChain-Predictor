...
class EvalutionClassComparitive(object):
    def __init__(self, LOADING_FACTOR, selectCase, M, dataSetString, M_episodes_QLearning, EXPLOREQLearning, answerQLearning, repeatedSequencesQLearning, numRiskyFaultChainsQLearning, allFalseCountQLearning, M_episodes_GRQN, EXPLOREGRQN, answerGRQN, repeatedSequencesGRQN, numRiskyFaultChainsGRQN, allFalseCountGRQN, lossGRQN):
        self.M = M
        ...
        self.answerGRQN = answerGRQN
        self.repeatedSequencesGRQN = repeatedSequencesGRQN
        self.numRiskyFaultChainsGRQN = numRiskyFaultChainsGRQN
        self.allFalseCountGRQN = allFalseCountGRQN
        self.lossGRQN = lossGRQN
    ...
    def display_results(self):
        ...
        print("Q-Learning: Found ",  self.how_many_risky_fcs()[0], " Risky FCs in ", self.M_episodes_QLearning, " search trials")
        ...
        print(" ")
        print("----Results: GRQN-----")
        print("GRQN: Found ",  self.how_many_risky_fcs()[1], " Risky FCs in ", self.M_episodes_GRQN, " search trials")
        print("GRQN: The cumulative risk is ", sum(self.rewardsGRQN))
        print("GRQN: Number of ALL False conditions: ", self.allFalseCountGRQN)
    ...
    def how_many_risky_fcs(self):
        ...
        countGRQN = 0
        for episode in self.answerGRQN:
            if tuple(episode[2]) in self.riskyFaultChainDict:
                countGRQN += 1

        return (countQLearning, countGRQN)

    def plot_loss(self):
        plt.plot(self.lossGRQN, label = "GRQN training loss")
    ...
    def plot_rewards(self):
        ...
        self.rewardsGRQN = [a for a, b, c in self.answerGRQN]
        plt.plot(self.rewardsGRQN, label = "GRQN rewards collected")
        plt.plot(self.rewardsQLearning, label = "Q-learning rewards collected")
    ...
    def plot_num_risky_fcs(self):
        ...
        plt.plot(np.cumsum(self.numRiskyFaultChainsGRQN), label = "GRQN number of risky FCs")
        plt.plot(np.cumsum(self.numRiskyFaultChainsQLearning), label = "Q-learning number of risky FCs")
        plt.xlabel("Search Episodes")
    ...
    def plot_fc_risk(self):
        ...
        plt.plot(np.cumsum(self.rewardsGRQN), label = "GRQN accumulated risk")
        plt.plot(np.cumsum(self.rewardsQLearning), label = "Q-learning accumulated risk")
        plt.xlabel("Search Episodes")
...
class EvalutionClassThreeComparitive(object):
    def __init__(self, riskyFaultChainDict, LOADING_FACTOR, selectCase, M, dataSetString, M_episodes_QLearning, EXPLOREQLearning, answerQLearning, repeatedSequencesQLearning, numRiskyFaultChainsQLearning, allFalseCountQLearning, M_episodes_GRQN, EXPLOREGRQN, answerGRQN_kappa_3, repeatedSequencesGRQN_kappa_3, numRiskyFaultChainsGRQN_kappa_3, allFalseCountGRQN_kappa_3, lossGRQN_kappa_3, M_episodes_TE, EXPLORE_TE, answer_TE, repeatedSequences_TE, numRiskyFaultChains_TE, allFalseCount_TE, answerGRQN_kappa_2, repeatedSequencesGRQN_kappa_2, numRiskyFaultChainsGRQN_kappa_2, allFalseCountGRQN_kappa_2, lossGRQN_kappa_2, answerGRQN_kappa_1, repeatedSequencesGRQN_kappa_1, numRiskyFaultChainsGRQN_kappa_1, allFalseCountGRQN_kappa_1, lossGRQN_kappa_1):
        self.M = M
...
class EvaluationClassIterationMCPlot(object):
    def __init__(self, totalNumRiskyGRQN_kappa_3, totalRiskGRQN_kappa_3, totalNumRiskyQLearning, totalRiskQLearning, totalNumRisky_TE, totalRisk_TE, totalNumRiskyGRQN_kappa_2, totalRiskGRQN_kappa_2, totalNumRiskyGRQN_kappa_1, totalRiskGRQN_kappa_1):
