...
class FaultChainSovlerClass(object):
    ...
    def load_dataset(self, dataSetString):
        ...
        with h5py.File(dataSetString, 'r') as hf:
            dataSet = hf[dataSetString[:-3]][:]     # removing the last three digits of the file name in order to load the dataset
...
if __name__ == '__main__':
    """
    This "__main__" function to ensure that the the above developed function actually work as expected.
    """
    ...
    # given snapshot of the power-grid, you can use this FCsovler;
