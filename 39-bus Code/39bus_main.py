...
iteration_track = 1  # 0 for fixed time base and 1 for fixed number of iterations S based 
M_episodes_qlearning = TOTAL_EPISODES
M_episodes_drqn = TOTAL_EPISODES

if iteration_track==0:  # run
    time_taken = 60*5     # set fixed time (in seconds) - run for 5 minutes
...
EPSILON_1_m = 0.01
GAMMA = 0.99
EXPLORE = 250            # irrelevant now since I have a separate buffer intitialized offline!
