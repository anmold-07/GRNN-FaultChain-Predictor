...
if __name__ == '__main__':
    ...
    iteration_track = 1     # 0 for fixed time base and 1 for fixed number of iterations S 
    ...
    dataSet = FCsovler.load_dataset(dataset_path) # finding risky FC dictionary for evaluation of results! 
    ...
    sample_length = 3
    batch_size = 32
    learning_rate = 0.005      # 39bus: 0.005, 118bus:  make sure this changes over time!
